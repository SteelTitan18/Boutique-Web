...
import tg.univlome.epl.boutique.messages.CategorieMessage;
 ...
 */
public class CategorieMessageListener implements ServletContextListener, MessageListener {

    @Inject
    @JMSConnectionFactory("jms/boutiqueConnectionFactory")
    private JMSContext context;
    
    @Resource(lookup = "jms/categorieQueue")
    private Queue queue;
    
    private CategorieService service;
    
    public CategorieMessageListener() {
    ...
    public void onMessage(Message msg) {
        try {
            CategorieMessage message = msg.getBody(CategorieMessage.class);
            ...
            Logger.getLogger(CategorieMessageListener.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
